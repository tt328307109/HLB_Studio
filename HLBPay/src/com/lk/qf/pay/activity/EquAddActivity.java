...
public class EquAddActivity extends BaseActivity{
	...
	private TextView cashin_show_msg_text,text_czhi;// 刷卡状态
	...
	private void initUI() {
		...
		text_czhi = (TextView) findViewById(R.id.text_czhi);
		text_czhi.setOnClickListener(new OnClickListener() {
	...
	private void goNext(String ksn){
