...
//		ConsumptionDetailTask task = new ConsumptionDetailTask();
...
//			dialog = new ShowDialog(ConsumptionDetailActivity.this);
...
//			return NetCommunicate.getData(URLs.QUERY_ORDER_DETAILS_CONSUME, map);
//		}
//		@Override
...
//	}
	...
	private void showDetail(Map<String, Object> result) {
		...
		llShow.addView(llNo);
		//商户名称
		LinearLayout llMerName = (LinearLayout) inflater.inflate(R.layout.deal_detail_item_explain, null);
		((TextView)llMerName.findViewById(R.id.deal_detail_explain_key)).setText("商户名称");
		((TextView)llMerName.findViewById(R.id.deal_detail_explain_value)).setText(toS(result.get("MERNAME")));
		llShow.addView(llMerName);
		//交易金额
