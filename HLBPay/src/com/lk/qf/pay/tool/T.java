...
public class T {
	 ...
	 */
	private T() {
		mContext=MApplication.mApplicationContext.getApplicationContext();
	}
	...
	public static void sl( String text) {
		System.out.println("error:applicationContextNULL");
		if(null==mContext){
			return;
		}
	...
	public static void ss(String msg) {
		Toast.makeText(
				MApplication.mApplicationContext.getApplicationContext(), msg,
