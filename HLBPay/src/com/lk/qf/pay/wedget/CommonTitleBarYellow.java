 ...
 * @author Ding
 */
public class CommonTitleBarYellow extends LinearLayout implements OnClickListener {
	private String title;

	public CommonTitleBarYellow(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public CommonTitleBarYellow(Context context) {
		this(context,null);
	}
	...
	private void initView() {
		root = LayoutInflater.from(getContext()).inflate(
				R.layout.common_title_bar_yellow_layout, null);
		btn_back = (LinearLayout) root.findViewById(R.id.common_title_back2);
		btn_back.setOnClickListener(this);
		tv_name = (TextView) root.findViewById(R.id.common_title_name2);
		tv_more = (TextView) root.findViewById(R.id.common_title_more2);
		tv_more.setOnClickListener(this);
		tv_back_des = (TextView) root
				.findViewById(R.id.common_title_tv_btnback_des2);
	...
	public void onClick(View v) {
		...
		case R.id.common_title_back2:
			...
			break;
		case R.id.common_title_more2:
			// Toast.makeText(getContext(), "Click1", 5000).show();
			break;
		}
	}

	public CommonTitleBarYellow setCanClickDestory(Activity ctx, boolean enable) {
		this.activity = ctx;
		canDestory = enable;
		return this;
	}
	 ...
	 * 设置Activity标题
	 */
	public CommonTitleBarYellow setActName(String actName) {
	...
	public CommonTitleBarYellow setDeawableRight(Drawable draw) {
