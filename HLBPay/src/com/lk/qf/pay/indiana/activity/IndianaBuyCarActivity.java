...
public class IndianaBuyCarActivity extends IndianaBaseActivity implements
		OnClickListener, OnRefreshListener2<ListView>, MyEditTextListener , PayListener {
	...
	private int goodsNum, goodsTotalAccount;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.indiana_buycar_layout);
		init();
	}
	...
	private void init() {
		findViewById(R.id.ll_buyCar_back2).setOnClickListener(this);
		imageLoader = ImageLoader.getInstance();
		imageLoader.init(ImageLoaderConfiguration.createDefault(this));
		options = ImgOptions.initImgOptions();
		llDefault = (LinearLayout) findViewById(R.id.ll_indiana_buycar_default);
		llBottom = (LinearLayout) findViewById(R.id.ll_buyCar_bottom);
		tvTotalAccount = (TextView) findViewById(R.id.tv_indaina_bc_total_account);
		tvGoodsNum = (TextView) findViewById(R.id.tv_indaina_bc_total_buyNum);
		tvGotoSee = (TextView) findViewById(R.id.tv_goShop);
		tvGotoSee.setOnClickListener(this);
		btnToBuy = (Button) findViewById(R.id.btn_indaina_bc_goPay);
		btnToBuy.setOnClickListener(this);
		list = new ArrayList<IndianaGoodsInfo>();
		postQueryBuyCarList();
		lv = (PullToRefreshListView) findViewById(R.id.ll_indiana_buycar_list);
		adapter = new IndianaBuyCarListAdapter(this, list, mListener, options,
				imageLoader);
	...
	public void onClick(View arg0) {
		...
		case R.id.btn_indaina_bc_goPay:
			if (goodsTotalAccount > 0) {
				size = list.size();
				isGo = true;
//				Intent intent = new Intent(IndianaBuyCarActivity.this,
//						MyPwdActivity.class);
//				intent.putExtra("account", "" + goodsTotalAccount);
//				startActivityForResult(intent, 000);
//				 mDialogWidget = new DialogWidget(IndianaBuyCarActivity.this,
//				 getDecorViewDialog());
//				 mDialogWidget.show();
				 
				//弹出对话框
					mPassWdDialog = PassWdDialog.getInstance(IndianaBuyCarActivity.this ,
							goodsTotalAccount + "" , PassWdDialog.INDIANA_MARK);
					mPassWdDialog.setPayListener(IndianaBuyCarActivity.this);
					mPassWdDialog.show();
			} else {
				T.ss("购买数量不能为0");
			}
		...
		public void myOnClick(int positio, View v) {
			...
			case R.id.ib_indiana_bc_Add: // 点击添加数量按钮，执行相应的处理
				...
				if (tag != null && tag instanceof Integer) { // 解决问题：如何知道你点击的按钮是哪一个列表项中的，通过Tag的position
					...
					goodsNum = num;
//					addToBuyCar(list.get(position).getGoodsId(), goodsNum, goodsNum, "Updata");
					...
					addToBuyCar(list.get(position).getGoodsId2(), goodsNum, goodsNum, "Updata");
				}
				break;
...
//						addToBuyCar(list.get(position).getGoodsId(), goodsNum, goodsNum, "Updata");
			...
			case R.id.img_indiana_bc_icon:
				Intent intent = new Intent(IndianaBuyCarActivity.this, IndianaGoodsInfoActivity.class);
	...
	protected View getDecorViewDialog() {
		// TODO Auto-generated method stub
		return PayPasswordView.getInstance("夺宝币" + goodsTotalAccount+"个",
				IndianaBuyCarActivity.this, new OnPayListener() {
