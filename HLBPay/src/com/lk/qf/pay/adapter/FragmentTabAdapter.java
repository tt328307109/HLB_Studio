...
//                    fragment.onStart(); // 启动目标tab的onStart()
    ...
    private FragmentTransaction obtainFragmentTransaction(int index){
        ...
        // 设置切换动画
        if(index > currentTab){
            ft.setCustomAnimations(R.anim.activity_open_left_in, R.anim.activity_open_right_out);
        }else{
            ft.setCustomAnimations(R.anim.activity_close_right_in, R.anim.activity_close_right_out);
        }
        return ft;
    }
